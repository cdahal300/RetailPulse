...
- Cache lifecycle: report reads and pending commands are scoped to the signed-in account and store, report cache entries expire after 24 hours, legacy unscoped keys are removed after authentication, and logout clears the active account’s portal data.
