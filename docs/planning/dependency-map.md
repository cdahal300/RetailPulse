...
| FEAT-008 Observability | Operability evidence | All runtimes | Cross-cutting |
| FEAT-009 PWA | Manager and owner workflows | FEAT-005 and read models | 6 |
| FEAT-010 Analytics | Governed aggregates | FEAT-003 and event contracts | 7 |
